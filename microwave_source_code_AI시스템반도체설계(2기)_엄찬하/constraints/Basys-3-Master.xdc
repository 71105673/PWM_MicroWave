...
set_property -dict { PACKAGE_PIN L2   IOSTANDARD LVCMOS33 } [get_ports {motor_dir[0]}];#Sch name = JA2
set_property -dict { PACKAGE_PIN J2   IOSTANDARD LVCMOS33 } [get_ports {motor_dir[1]}];#Sch name = JA3
